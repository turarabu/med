    ...
    return function o(r, s, l) {
        ...
        4: [function(t, e, i) {
            ...
            function x(t) {
                ...
                return a = o <= 8 ? (i = 100 * o / 903.3) / 100 * 7.787 + 16 / 116 : (i = 100 * Math.pow((o + 16) / 116, 3),
                Math.pow(i / 100, 1 / 3)),
            ...
            e.exports = function(e) {
                e.controllers.bar = e.DatasetController.extend({
                    ...
                    calculateBarIndexPixels: function(t, e, i) {
                        ...
                        u = a.stackCount,
                        d = a.pixels[n],
                        s = S.isNullOrUndef(l) ? (r = a.min * o.categoryPercentage,
                        o.barPercentage) : (r = l * u,
                        1),
                        {
                            chunk: r / u,
                            ratio: s,
                            start: d - r / 2
                        }), M = this.getStackIndex(t, this.getMeta().stack), w = k.start + k.chunk * M + k.chunk / 2, C = Math.min(S.valueOrDefault(y.maxBarThickness, 1 / 0), k.chunk * k.ratio);
                        return {
                            base: w - C / 2,
                            head: w + C / 2,
                            center: w,
        ...
        28: [function(t, e, i) {
            ...
            e.exports = function() {
                ...
                g.getRelativePosition = function(t, e) {
                    ...
                    n = s && 0 < s.length ? (i = s[0].clientX,
                    s[0].clientY) : (i = a.clientX,
                    a.clientY);
                    ...
                    if (D.display) {
                        ...
                        if (H.each(O, function(t, e) {
                            if (!H.isNullOrUndef(t.label)) {
                                ...
                                o = e === _.zeroLineIndex && D.offset === A.offsetGridLines ? (i = A.zeroLineWidth,
                                n = A.zeroLineColor,
                                a = A.zeroLineBorderDash,
                                A.zeroLineBorderDashOffset) : (i = H.valueAtIndexOrDefault(A.lineWidth, e),
                                ...
                                if (F) {
                                    var y = R + x;
                                    p = "bottom" === D.position ? (b = T ? "middle" : "top",
                                    v = T ? "right" : "center",
                                    _.top + y) : (b = T ? "middle" : "bottom",
                                    v = T ? "left" : "center",
                                    _.bottom - y);
        ...
        36: [function(t, e, i) {
            ...
            (e.exports = a.extend({
                ...
                update: function(t) {
                    var e, i, n, a, o, r, s, l, u, d, c, h, f, g, p, m, v, b, x, y, k = this, M = k._options, w = k._model, C = k._model = z(M), S = k._active, _ = k._data, D = {
                        xAlign: w.xAlign,
                        yAlign: w.yAlign
                    }, P = {
                        x: w.x,
                ...
                getCaretPosition: function(t, e, i) {
                    ...
                    if ("center" === h)
                        ...
                        r = s - u,
                        s + u);
                    else if (o = (n = "left" === c ? (a = f + d + u) - u : "right" === c ? (a = f + p - d - u) - u : (a = i.caretX) - u,
                    a + u),
                    "top" === h)
                        s = (r = g) - u,
                        l = r;
            ...
            var r = n.extend({
                ...
                fit: function() {
                    var n = this
                      ...
                      , h = n.minSize
                      , f = n.isHorizontal();
                    if (h.height = f ? (h.width = n.maxWidth,
                    e ? 10 : 0) : (h.width = e ? 10 : 0,
                    n.maxHeight),
                    e)
                        if (o.font = d,
                        f) {
            ...
            var r = n.extend({
                ...
                draw: function() {
                    var t = this
                      ...
                      , a = M.global;
                    if (n.display) {
                        var o, r, s, l = i(n.fontSize, a.defaultFontSize), u = i(n.fontStyle, a.defaultFontStyle), d = i(n.fontFamily, a.defaultFontFamily), c = w.fontString(l, u, d), h = w.options.toLineHeight(n.lineHeight, l), f = h / 2 + n.padding, g = 0, p = t.top, m = t.left, v = t.bottom, b = t.right;
                    ...
                    buildTicks: function() {
                        var t = this
                          ...
                          , a = t.ticks = function(t, e) {
                            ...
                            a < (n = 1) && (n = Math.pow(10, 1 - Math.floor(c.log10(a))),
                            s = Math.round(s * n) / n,
                            l = Math.round(l * n) / n),
                ...
                var t = {
                  ...
                  , e = n.extend({
                    ...
                    getPixelForValue: function(t) {
                        ...
                        a = r.end,
                        1),
                        i = r.isHorizontal() ? (e = r.width,
                        s ? r.right : r.left) : (e = r.height,
                        o *= -1,
                        s ? r.top : r.bottom),
                    ...
                    getValueForPixel: function(t) {
                        ...
                        o.start) : (i = o.start,
                        o.end),
                        (a = o.isHorizontal() ? (e = o.width,
                        r ? o.right - t : t - o.left) : (e = o.height,
                        r ? t - o.top : o.bottom - t)) !== i) {
                            if (0 === i) {
                    ...
                    determineDataLimits: function() {
                        ...
                        i = (s.data.datasets || []).length; t < i; ++t)
                            if (s.isDatasetVisible(t))
                                ...
                                f[t] = [];
                        g.length && (g = M(g).sort(b),
                        d = Math.min(d, g[0]),
                        c = Math.max(c, g[g.length - 1])),
                        h.length && (h = M(h).sort(b),
                        d = Math.min(d, h[0]),
